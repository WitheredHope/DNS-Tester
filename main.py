...
def check_primary_DNS_updated(domain, oldIP = None):
    primaryDNS = {'Google' : '8.8.8.8', 'Comodo_Secure_DNS' : '8.26.56.26', 'FreeDNS' : '37.235.1.174', 'Alternate_DNS' : '198.101.242.72', 'Dyn' : '216.146.35.35', 'DNS.WATCH' : '84.200.69.80', 'Cloudflare' : '1.1.1.1', 'GreenTeamDNS' : '81.218.119.11', 'Norton_ConnectSafe' : '199.85.126.10', 'Hurricane_Electric' : '74.82.42.42', 'Level3' : '209.244.0.3', 'Neustar_Security' : '156.154.70.1', 'OpenNIC' : '23.94.60.240', 'OpenDNS Home' : '208.67.222.222', 'Quad9' : '9.9.9.9', 'Yandex.DNS' : '77.88.8.8', 'SafeDNS' : '195.46.39.39', 'puntCAT' : '109.69.8.51', 'Verisign' : '64.6.46.6', 'UncensoredDNS' : '91.239.100.100'}
    checked = []
...
def check_secondary_DNS_updated(domain, oldIP = None):
    secondaryDNS = {'Google' : '8.8.4.4', 'Comodo_Secure_DNS' : '8.20.247.20', 'FreeDNS' : '37.245.1.177', 'Alternate_DNS' : '23.253.163.53', 'Dyn' : '216.146.36.36', 'DNS.WATCH' : '84.200.70.40', 'Cloudflare' : '1.0.0.1', 'GreenTeamDNS' : '209.88.198.133', 'Norton_ConnectSafe' : '199.85.127.10', 'Level3' : '209.244.0.4', 'Neustar_Security' : '156.154.71.1', 'OpenNIC' : '128.52.130.209', 'OpenDNS Home' : '208.67.220.220', 'Quad9' : '149.112.122.122', 'Yandex.DNS' : '77.88.8.1', 'SafeDNS' : '195.46.39.40', 'Verisign' : '64.6.65.6', 'UncensoredDNS' : '89.233.43.71'}
    checked = []
...
def main():
    ...
    #add the current websites to the config file for use with flask
    ...
    for item in todo:
        ...
        file.write(item + " " + str(datetime.datetime.now()) + "\n")
